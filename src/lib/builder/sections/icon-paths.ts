/**
 * Lucide icon SVG path data for the string renderer.
 *
 * The React components use lucide-react (which renders <svg> at runtime),
 * but the string renderer needs raw SVG markup. This file provides the
 * inner SVG content for each icon name, so both renderers produce
 * identical icons.
 *
 * Each value is the inner HTML of an <svg viewBox="0 0 24 24"> — paths,
 * circles, lines, etc. The outer <svg> wrapper is added by renderIcon().
 *
 * Generated from lucide-react@0.525.0 via renderToStaticMarkup.
 */
...
export const ICON_PATHS: Record<string, string> = {
  ...
  GitBranch: '<line x1="6" x2="6" y1="3" y2="15"></line><circle cx="18" cy="6" r="3"></circle><circle cx="6" cy="18" r="3"></circle><path d="M18 9a9 9 0 0 1-9 9"></path>',
  ...
  Layout: '<rect width="18" height="18" x="3" y="3" rx="2"></rect><path d="M3 9h18"></path><path d="M9 21V9"></path>',
  Clapperboard: '<path d="M20.2 6 3 11l-.9-2.4c-.3-1.1.3-2.2 1.3-2.5l13.5-4"></path><path d="M6.2 5.3 3.1 6.4"></path><path d="M3.3 10.5 20 6.4"></path><path d="M14 6.5 11 7.3"></path><path d="M9.5 7.8 6.5 8.5"></path><path d="M22 8v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8"></path><path d="M2 12h20"></path><path d="M2 16h20"></path><path d="M2 20h20"></path>',
  ...
  Feather: '<path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z"></path><line x1="16" x2="2" y1="8" y2="22"></line><line x1="17.5" x2="9" y1="15" y2="15"></line>',
  ...
  Phone: '<path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384z"></path>',
  ...
  Headphones: '<path d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><path d="M21 14h-3a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2z"></path><path d="M3 14a9 9 0 0 1 18 0"></path>',
...
/** Render a Lucide icon as an SVG string. Falls back to Sparkles if unknown. */
export function renderIconSvg(name: string | undefined, className = "h-5 w-5"): string {
  const paths = (name && ICON_PATHS[name]) || ICON_PATHS.Sparkles;
  return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-${(name || "sparkles").toLowerCase()} ${className}" aria-hidden="true">${paths}</svg>`;
}
